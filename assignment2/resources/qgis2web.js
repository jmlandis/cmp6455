...
map.getView().fit([-12521599.439787, 4923706.288212, -12374708.031894, 5002571.376732], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Salt Lake County Pedestrian Crash Data 2015-2019</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (219 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Salt Lake County Crash Data sourced from State of Utah traffic crash data 2015-2019. Filtered for pedestrian-involved crashes by year.<br />https://opendata.utah.gov/Public-Safety/State-of-Utah-Crash-Data-2015-2019/7ihm-46s4';
            }
